...
from newbie.nltk_processing import NltkProcess
...
if __name__ == '__main__':
    ...
    if scheduler.running is False:
        ...
        with app.app_context():
            ...
            scheduler.add_job(func=get_auth_zero, trigger='cron', hour='*', minute=15)
            scheduler.add_job(func=updates_from_slack, trigger='cron', hour=10, minute=6)
    app.debug = False
