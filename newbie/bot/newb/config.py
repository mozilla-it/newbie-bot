...
all_timezones = [
    ...
    {'zone': 'Africa/Lusaka', 'name': 'Africa/Lusaka'},
    {'zone': 'Africa/Malabo', 'name': 'Africa/Malabo'},
    {'zone': 'Africa/Maputo', 'name': 'Africa/Maputo'},
    {'zone': 'Africa/Maseru', 'name': 'Africa/Maseru'},
    {'zone': 'Africa/Mbabane', 'name': 'Africa/Mbabane'},
    {'zone': 'Africa/Mogadishu', 'name': 'Africa/Mogadishu'},
    {'zone': 'Africa/Monrovia', 'name': 'Africa/Monrovia'},
    {'zone': 'Africa/Nairobi', 'name': 'Africa/Nairobi'},
    {'zone': 'Africa/Ndjamena', 'name': 'Africa/Ndjamena'},
    {'zone': 'Africa/Niamey', 'name': 'Africa/Niamey'},
    {'zone': 'Africa/Nouakchott', 'name': 'Africa/Nouakchott'},
    {'zone': 'Africa/Ouagadougou', 'name': 'Africa/Ouagadougou'},
    {'zone': 'Africa/Porto-Novo', 'name': 'Africa/Porto-Novo'},
    {'zone': 'Africa/Sao_Tome', 'name': 'Africa/Sao_Tome'},
    {'zone': 'Africa/Timbuktu', 'name': 'Africa/Timbuktu'},
    {'zone': 'Africa/Tripoli', 'name': 'Africa/Tripoli'},
    {'zone': 'Africa/Tunis', 'name': 'Africa/Tunis'},
    {'zone': 'Africa/Windhoek', 'name': 'Africa/Windhoek'},
    {'zone': 'America/Adak', 'name': 'America/Adak'},
    {'zone': 'America/Anchorage', 'name': 'America/Anchorage'},
    {'zone': 'America/Anguilla', 'name': 'America/Anguilla'},
    {'zone': 'America/Antigua', 'name': 'America/Antigua'},
    {'zone': 'America/Araguaina', 'name': 'America/Araguaina'},
